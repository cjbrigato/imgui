...
bool    ImGui_Marmalade_Init(bool install_callbacks)
{
    ...
    io.KeyMap[ImGuiKey_Apostrophe] = s3eKeyApostrophe; // '
    io.KeyMap[ImGuiKey_Comma] = s3eKeyComma; // ,
    io.KeyMap[ImGuiKey_Minus] = s3eKeyMinus; // -
    io.KeyMap[ImGuiKey_Period] = s3eKeyPeriod; // .
    io.KeyMap[ImGuiKey_Slash] = s3eKeySlash; // /
    io.KeyMap[ImGuiKey_Semicolon] = s3eKeySemicolon; // ;
    io.KeyMap[ImGuiKey_Equal] = s3eKeyEquals; // =
    io.KeyMap[ImGuiKey_LeftBracket] = s3eKeyLeftBracket; // [
    io.KeyMap[ImGuiKey_Backslash] = s3eKeyBackSlash; // \ (this text inhibit multiline comment caused by backlash)
    io.KeyMap[ImGuiKey_RightBracket] = s3eKeyRightBracket; // ]
    io.KeyMap[ImGuiKey_GraveAccent] = s3eKeyBacktick; // `
    io.KeyMap[ImGuiKey_CapsLock] = s3eKeyCapsLock;
    io.KeyMap[ImGuiKey_ScrollLock] = s3eKeyScrollLock;
    io.KeyMap[ImGuiKey_NumLock] = s3eKeyNumLock;
    io.KeyMap[ImGuiKey_PrintScreen] = s3eKeyPrintScreen;
    io.KeyMap[ImGuiKey_Pause] = s3eKeyPause;
    io.KeyMap[ImGuiKey_KeyPad0] = s3eKeyNumPad0;
    io.KeyMap[ImGuiKey_KeyPad1] = s3eKeyNumPad1;
    io.KeyMap[ImGuiKey_KeyPad2] = s3eKeyNumPad2;
    io.KeyMap[ImGuiKey_KeyPad3] = s3eKeyNumPad3;
    io.KeyMap[ImGuiKey_KeyPad4] = s3eKeyNumPad4;
    io.KeyMap[ImGuiKey_KeyPad5] = s3eKeyNumPad5;
    io.KeyMap[ImGuiKey_KeyPad6] = s3eKeyNumPad6;
    io.KeyMap[ImGuiKey_KeyPad7] = s3eKeyNumPad7;
    io.KeyMap[ImGuiKey_KeyPad8] = s3eKeyNumPad8;
    io.KeyMap[ImGuiKey_KeyPad9] = s3eKeyNumPad9;
    io.KeyMap[ImGuiKey_KeyPadDecimal] = s3eKeyNumPadPeriod;
    io.KeyMap[ImGuiKey_KeyPadDivide] = s3eKeyNumPadSlash;
    io.KeyMap[ImGuiKey_KeyPadMultiply] = s3eKeyStar;
    io.KeyMap[ImGuiKey_KeyPadSubtract] = s3eKeyNumPadMinus;
    io.KeyMap[ImGuiKey_KeyPadAdd] = s3eKeyNumPadPlus;
    io.KeyMap[ImGuiKey_KeyPadEnter] = s3eKeyNumPadEnter;
    io.KeyMap[ImGuiKey_KeyPadEqual] = 0; // not supported
    io.KeyMap[ImGuiKey_LeftShift] = s3eKeyLeftShift;
    io.KeyMap[ImGuiKey_LeftControl] = s3eKeyLeftControl;
    io.KeyMap[ImGuiKey_LeftAlt] = s3eKeyLeftAlt;
    io.KeyMap[ImGuiKey_LeftSuper] = s3eKeyLeftWindows;
    io.KeyMap[ImGuiKey_RightShift] = s3eKeyRightShift;
    io.KeyMap[ImGuiKey_RightControl] = s3eKeyRightControl;
    io.KeyMap[ImGuiKey_RightAlt] = s3eKeyRightAlt;
    io.KeyMap[ImGuiKey_RightSuper] = s3eKeyRightWindows;
    io.KeyMap[ImGuiKey_Menu] = s3eKeyMenu;
    ...
    io.KeyMap[ImGuiKey_F11] = 0; // not supported
    io.KeyMap[ImGuiKey_F12] = 0; // not supported
